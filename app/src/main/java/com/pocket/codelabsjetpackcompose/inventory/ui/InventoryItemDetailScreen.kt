...
@Composable
fun InventoryItemDetailScreen(inventoryId : Int?, viewModel: InventoryItemDetailsViewModel = viewModel(factory = AppViewModelProvider.Factory)) {
    val coroutineScope = rememberCoroutineScope()
    coroutineScope.launch {
        viewModel.getInventoryDetails(inventoryId?:0)
    }
    ItemDetailsBody(
        itemDetailsUiState = viewModel.inventoryItemDetailUiState ,
        onSellItem = { },
        onDelete = { },
        modifier = Modifier
            .padding(
...
private fun ItemDetailsBody(
    ...
    Column(
        ...
        ItemDetails(
            item = itemDetailsUiState.inventoryItemDetails.toItem(),
