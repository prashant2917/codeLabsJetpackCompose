...
fun InventoryItemEntryScreen(
    navigateBack: () -> Unit,
    viewModel: InventoryItemEntryViewModel = viewModel(factory = AppViewModelProvider.Factory)
) {
    val coroutineScope = rememberCoroutineScope()

    InventoryItemEntryBody(
        itemUiState = viewModel.inventoryItemUiState,
...
fun InventoryItemEntryBody(
    ...
    Column(
        ...
        ItemInputForm(
            itemDetails = itemUiState.inventoryItemDetails,
